# -*- coding: utf-8 -*-
"""
Created on Tue Nov  7 09:52:47 2023

@author: 700001473
"""

# with help from https://martin-ueding.de/posts/project-euler-solution-11-largest-product-in-a-grid/
...
def word_to_int(word: str) -> int:
    if word[0] == "0": # we need this to avoid octal misunderstandings
        return int(word[1:])
    else:
        return int(word)
